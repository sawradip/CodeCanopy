...
def create_test_project():
    ...
    files = {
        ...
        "src/components/Header.js": ("export const Header = () => <h1>Header</h1>;"),
...
def test_tree_functionality():
    ...
    try:
        ...
        # Test depth limiting
        result = generator.generate(root_path=test_dir, global_depth=1)
...
def test_cat_functionality():
    ...
    try:
        # Test basic cat
        result = generator.generate(patterns=["src/index.js"], base_path=test_dir)
        assert "index.js" in result
        assert "Hello World" in result
        print("✓ Basic cat generation works")

        # Test glob patterns
        result = generator.generate(patterns=["src/**/*.js"], base_path=test_dir)
